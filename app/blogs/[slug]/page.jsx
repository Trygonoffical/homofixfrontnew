...
const BlogPage = ({ params }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(`https://support.homofixcompany.com/api/Blog/${slugify(params.slug)}/`, { cache: 'no-store' });
  ...
  return (
    <>
      <main>
        ...
        <div className="container mx-auto max-w-[1200] pb-20 p-4">
